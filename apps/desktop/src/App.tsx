...
export function App() {
  ...
  const [audioAnalysisInProgress, setAudioAnalysisInProgress] = useState(false);
  ...
  async function loadAudio() {
    if (!project) return;
    setAudioAnalysisInProgress(true);
    try {
      ...
      setAudioAnalysisInProgress(false);
    }
  }
