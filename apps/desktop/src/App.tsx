...
function ExportPanel({ project, audioPath, stats, sliceRange, previewJobs, production, productionStatus, useFinalSliceSettings, setProduction, setPreviewJobs, setUseFinalSliceSettings, run }: ExportPanelProps) {
  return <section className="panel exporter-page"><div className="exporter-content">
